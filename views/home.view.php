                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    <?php if (is_logged_in()): ?>
                        <a href="profile.php" class="btn btn-primary btn-lg d-flex align-items-center gap-2">
                            <i class="bi bi-person-circle"></i> Votre Espace Personnel
                        </a>
                    <?php else: ?>
                        <a href="register.php" class="btn btn-primary btn-lg d-flex align-items-center gap-2">
                            Commencer maintenant <i class="bi bi-rocket-takeoff"></i>
                        </a>
                        <a href="login.php" class="btn btn-outline-light btn-lg d-flex align-items-center gap-2 border-opacity-25" style="backdrop-filter: blur(8px);">
